          ...
          <div class="col-sm-7 pt-5 pb-5 align-middle align-items-center m-auto">
              <div class="text-center maxwidth350px m-auto pt-2 pb-2">
                <div class="text-left mb-4"> <a href="{{url('/')}}"><img src="images/assets/login/asset37.png" class="img-fluid col-sm-1 col-1 p-0">
                  ...
                  <h4 class="helveticabold-font sign-msg">Sign Up</h4>
                 <form id="signupUser" method="POST" method="post">
                     @csrf
                 ...
                 <div class="text-left mt-3">
                  ...
                  <div class="mt-4"> <button type="submit" class="btn bgyellow-gradiant mt-3 border borderyellow colorwhite borderradius30px helveticabold-font col-sm-12 fontsize14px pt-3 pb-3 nexthover">Sign Up</button></div>

                  </form>

                  <div class="text-center mt-5 pt-5"><p class="greycolor fontsize12px">or 
                    <a href="{{url('login')}}" class="colorblack helveticafont text-decoration-none">Login Instead</a></p></div>
