			...
			<div class="col-sm-12 p-4">
					<div class="w-100 d-flex flex-wrap">
						...
						<ul class="p-0 mt-2 mb-0 list-unstyled">
							...
							<li class="d-inline-block align-text-bottom"><p class="fontsize14px mb-0 greycolor helveticafont">Goal Based Plans</p></li>
						</ul>
						</div>
					...
					<div class="w-100 mt-5 d-flex flex-wrap">
						...
						<!-- 	 plans package -->
				                <div class="col-sm-12 pl-sm-5 pr-sm-5 pl-1 pr-1">
				                    <div class="owl-carousel owl-theme carousel-packages">
				                        <div class="items bg-white borderradius15px overflow-hidden mb-3">
				                            <div class="bggreen-gradiant text-center w-100 p-3">
				                            	<img src="{{asset('images/assets/login/Asset61.png')}}" class="img-fluid col-sm-5 col-6 p-2 m-auto">
				                            	<h5 class="helveticabold-font text-white pt-2 pb-2">Umrah</h5>
				                            ...
				                            <div class="p-sm-3 p-2 pt-4 pb-5">
				                            	...
				                            	<a href="{{url('/umrah')}}" class="btn bgyellow-gradiant mt-3 border borderyellow colorwhite borderradius30px helveticafont w-100 fontsize16px pt-2 pb-2 nexthover lineheight2px">View Plan</a>
				                            </div>
				                        </div>                        
				                       <div class="items bg-white borderradius15px overflow-hidden mb-3">
				                            <div class="bggreen-gradiant text-center w-100 p-3">
				                            	<img src="{{asset('images/assets/login/Asset60.png')}}" class="img-fluid col-sm-5 col-6 p-2 m-auto">
				                            	<h5 class="helveticabold-font text-white pt-2 pb-2">Education</h5>
				                            	<p class="helveticafont text-white mb-0 font-weight-light fontsize15px">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh.</p>
				                            </div>
				                            <div class="p-sm-3 p-2 pt-4 pb-5">
				                            	<h5 class="helveticafont text-center">Want to review <br/> these documents </h5>
				                        ...
				                        <div class="items bg-white borderradius15px overflow-hidden mb-3">
				                            <div class="bggreen-gradiant text-center w-100 p-3">
				                            	<img src="{{asset('images/assets/login/Asset59.png')}}" class="img-fluid col-sm-5 col-6 p-2 m-auto">
				                            	<h5 class="helveticabold-font text-white pt-2 pb-2">Marriage</h5>
				                            	<p class="helveticafont text-white mb-0 font-weight-light fontsize15px">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh.</p>
				                            </div>
				                            <div class="p-sm-3 p-2 pt-4 pb-5">
				                            	<h5 class="helveticafont text-center">Want to review <br/> these documents </h5>
