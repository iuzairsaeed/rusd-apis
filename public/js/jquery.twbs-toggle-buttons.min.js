...
var TwbsToggleButtons=function(a,b){this.$_element=a;this._initializeOptions(b);this._initializeDOM();this.$_element.find(this._options.twbsBtnSelector).on("click",this._eventClick.bind(this));this.$_element.data("twbsToggleButtons",this)};TwbsToggleButtons.TYPE_RADIO=function(){return 1};TwbsToggleButtons.TYPE_CHECKBOX=function(){return 2};TwbsToggleButtons.DEFAULTS=function(){return{twbsBtnSelector:"[role='button']",classActive:"bgyellow-gradiant",classInactive:"bg-transparent"}};
